...
namespace WindowsFormsApplication1.Util
{
    ...
    public class BaseSqliteSql
    {
        ...
        public BaseSqliteSql()
        {
            try
            {
                String connectionString = "data source = "+ AppDomain.CurrentDomain.BaseDirectory + "duqiu.db";
